...
Material::Material(Shader* shader, const std::string& colorPath, const std::string& normalPath, const std::string& specularPath, const std::string& roughnessPath, const std::string& emiPath) : m_shader(shader) {
